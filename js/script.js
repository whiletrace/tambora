...
$(document).ready(function() {
	$(".content1").typetype("Today was a great day, we finaly came upon the Island of Sambawa It is located in Indonesia 400 miles South of Java. We are looking forward to explore the Island and all of it's beauty", {
...
$(document).ready(function() {
	$(".content2").typetype("We have finnaly gotten a chance to walk around a bit. We came accross a huge mountain. It must be at least 14,000 ft tall. We heard that this moutain is called Mt. Tambora. and that actually is a volcano. This volcano is said to be one of many in what is known as the Pacific Ring of fire",{
    e: 0., // error rate. (use e=0 for perfect typing)
